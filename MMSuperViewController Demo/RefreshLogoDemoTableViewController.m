//
//  RefreshLogoDemoTableViewController.m
...
@interface RefreshLogoDemoTableViewController ()
...
@implementation RefreshLogoDemoTableViewController
...
- (MMRefreshDefaultView *)refreshHeaderView1
{
    if (!_refreshHeaderView1) {
		_refreshHeaderView1 = [[MMRefreshLogoView alloc] initWithFrame:CGRectMake(0.0f, 0.0f - self.tableView.bounds.size.height, self.view.frame.size.width, self.tableView.bounds.size.height)];
